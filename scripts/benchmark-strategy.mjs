...
const { compressImageFile } = await import(pathToFileURL(nodeEntry).href);
...
for (const sample of samples) {
  ...
  const result = await compressImageFile(sample, {
    outputDir: smartuOutputDir,
